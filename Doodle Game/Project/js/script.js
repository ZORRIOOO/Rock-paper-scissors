...
document.addEventListener("DOMContentLoaded", () => {
    ...
    class Platform {
        constructor(newPlatBotttom) {
            this.bottom = newPlatBotttom;
    ...
    function createPlatforms() {
        for (let i = 0; i < platformCount; i++) {
            ...
            let newPlatBotttom = 100 + i * platGap;
            let newPlatform = new Platform(newPlatBotttom);
    ...
    function fall() {
        ...
        isJumping = false;
        dowmTimerId = setInterval(function () {
